...
if("TRUE" STREQUAL "TRUE")
  set(motion_plan_SOURCE_PREFIX /home/sintsh/Multi-Strategy-Wheeled-Robot-System-for-Navigation/simulation_ws/src/motion_plan)
  set(motion_plan_DEVEL_PREFIX /home/sintsh/Multi-Strategy-Wheeled-Robot-System-for-Navigation/simulation_ws/devel)
  ...
  set(motion_plan_INSTALL_PREFIX /home/sintsh/Multi-Strategy-Wheeled-Robot-System-for-Navigation/simulation_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'sintsh <sintsh@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motion_plan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sintsh/Multi-Strategy-Wheeled-Robot-System-for-Navigation/simulation_ws/src/motion_plan/${idir}'.  ${_report}")
    endif()
